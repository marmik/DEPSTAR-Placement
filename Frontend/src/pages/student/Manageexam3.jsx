        ...
        <div className=''>
          <div className='grid justify-between'>
            <table className='text-xl'>
              <tbody>
                <tr>
                  <td className="text-secondary font-bold pr-4">Total Obtained Marks</td>
                  <td className="text-gray-600 font-bold"> 
                    <h6 className='text-primary text-xl font-bold'>20</h6>
                  </td>
                </tr>
                <tr>
                  <td className="text-secondary font-bold pr-4">Total Right Answers</td>
                  <td className="text-gray-600 font-bold"> 
                    <h6 className='text-primary text-xl font-bold'>20</h6>
                  </td>
                </tr>
                <tr>
                  <td className="text-secondary font-bold pr-4">Total Wrong Answers</td>
                  <td className="text-gray-600 font-bold"> 
