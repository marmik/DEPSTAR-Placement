  ...
  return (
    <div className='p-4 text-secondary'>
      ...
      <div className="bg-white py-3">
        <h2 className="text-xl font-semibold mb-2">Search Quiz</h2>
        <label className="flex flex-col">
          <input
            type="text"
            placeholder="Search Quiz"
            className="p-4 border-2 sm:w-1/4 w-full  border-slate-300 rounded-md focus:border-primary focus:outline-none"
            value={searchQuery}
