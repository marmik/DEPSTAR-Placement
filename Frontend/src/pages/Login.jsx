  ...
  return (
    <>
      <div className="flex h-screen flex-row items-center justify-center">
        ...
        {/* form */}
        <div className="bg-white items-start h-full grid lg:w-1/2 w-10/12 ">
          ...
          <div className="sm:p-40  ">
            ...
            <div className="flex flex-row mb-5">
              <h2 className={(isstudent) ? "text-2xl font-semibold  text-gray-700 border-b-4 border-b-primary cursor-pointer" : "text-2xl font-semibold  text-gray-700 cursor-pointer"} onClick={() => setstudent(true)}>Student</h2>
              <h2 className={(!isstudent) ? "text-2xl font-semibold text-gray-  ml-10 border-b-4 border-b-primary cursor-pointer" : "text-2xl font-semibold text-gray-700 ml-10 cursor-pointer"} onClick={() => setstudent(false)}>Faculty</h2>
            </div>
          <br/>
