      ...
      <div className="flex h-screen flex-row items-center justify-center">
        <div className="shadow-lg flex flex-row  overflow-hidden h-full lg:w-1/2">
          <div className="relative hidden lg:block">
            ...
            <div className="absolute top-0 left-0 w-full h-full flex  flex-col justify-center bg-[#1057E5]  bg-opacity-80 opacity-70">
        ...
        {/* form */}
        <div className="bg-white lg:w-1/2 w-10/12 h-full ">
          ...
          <h1 className="font-bold text-gray-800 text-3xl flex lg:hidden md:hidden">Logo Here</h1>
          ...
          <form action="" className="flex flex-col w-full">
            <div className="flex flex-col mb-4 relative">
              ...
              <input type="email" name="" id="email" placeholder="username" className="px-4 py-2 border-2 border-slate-300 rounded-md max-w-full focus:border-blue-500 focus:outline-none" />
            </div>
            ...
            <button className="self-center my-6 bg-blue-600 hover:bg-blue-700 text-white font-medium text-lg px-4 py-2 rounded-md lg:self-end shadow-xl" >Login</button>
          </form>
          </div>
        </div>
      </div>
